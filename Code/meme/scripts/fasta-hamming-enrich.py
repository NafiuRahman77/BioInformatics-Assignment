...
def estimate_new_hamming_counts_col_let(counts, freqs, nsites, max_dist, col, old_comprise, new_comprise):
    ...
    in column col.
TODO: could add columns on either side of freqs array so we can do "lengthen" and "shift" moves.
